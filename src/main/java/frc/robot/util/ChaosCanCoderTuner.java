...
public class ChaosCanCoderTuner {
   ...
   */
  public DashboardNumber tunable(String valueName, double initialValue, BiConsumer<CANcoderConfiguration, Double> onUpdate) {
    return new DashboardNumber("CANCoderConfig/" + m_name + "/" + valueName, initialValue, true, false, newValue -> {
